...
\tcode{r} denotes a valid range~(\ref{range.requirements.implementations}) whose
...
range~(\ref{range.requirements.implementations}), or the value type of this range is
