...
\pnum
Constructors and member functions taking a \tcode{Range} template
argument shall not participate in overload resolution
unless \tcode{Range} is a range
type~(\ref{container.requirements.range}) with a value type
implicitly convertible to \tcode{charT}.
